<template>
    <div class="flex space-x-5">
            ...
            <div class="h-60 w-60 bg-white rounded-3xl shadow-md border border-[#F0F2F5]	">
                ...
                <h1 class="text-[#464646] text-lg font-medium ml-7 mt-10">Add links to build knowledge base</h1>
            ...
            <div class="h-60 w-60 bg-white rounded-3xl shadow-md border border-[#F0F2F5]	">
                ...
                <h1 class="text-[#464646] text-lg font-medium ml-7 mt-10">Ask questions and find insights</h1>
                <p class="text-sm text-[#A09A9E] ml-7 mt-1">Third Step</p>
            </div>
        </div>
</template>
